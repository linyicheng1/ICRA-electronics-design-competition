...
USB_MODULE="build/modules/driver/serial/serial_com_node"
...
LOCALIZATION_CLIENT="build/modules/perception/localization/localization_client"

ARMOR_DETECTION_MODULE="build/modules/perception/detection/armor_detection/armor_detection_node"

GLOBAL_PLANNING_CLIENT="build/modules/planning/global_planner/global_planner_client"
...
LOCAL_PLANNING_CLIENT="build/modules/planning/local_planner/local_planner_client"
...
if [ "${SIMULATION}" -eq 1 ]; then
	...
	MODULES=(${LOCALIZATION_MODULE} \
        	...
        	${GLOBAL_PLANNING_CLIENT}\
            ${LOCAL_PLANNING_CLIENT}\
        	${USB_MODULE}\
